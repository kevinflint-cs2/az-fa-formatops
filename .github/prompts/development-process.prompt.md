...
1. Read and confirm understanding of:
   - `.github/prompts/implementation-pattern.prompt.md`
...
1. Execute testing workflow:
   - Invoke `.github/prompts/testing.prompt.md` guidance
...
1. Execute quality checks:
   - Invoke `.github/prompts/linting-typechecking.prompt.md` guidance
   - Run: `ruff check . --fix`
   - Run: `ruff format .`
...
1. Execute documentation workflow:
   ...
   - Invoke `.github/prompts/documentation.prompt.md` guidance on documentation creation
...
1. Execute git workflow:
   - Invoke `.github/prompts/commit-and-merge.prompt.md` guidance
